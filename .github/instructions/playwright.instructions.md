...
- **Clarity**: Use descriptive test and step titles that clearly state the intent. Add comments only to explain complex logic or non-obvious interactions — see [`comments.instructions.md`](comments.instructions.md) for the philosophy (comment *why*, not *what*)
